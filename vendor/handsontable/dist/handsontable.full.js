...
//        instance.rootElement.addClass(settings.className);
   ...
   * @type {String}
   */
  this.version = '0.13.1'; //inserted by grunt from package.json
};
...
DefaultSettings.prototype = {
  ...
  /**
  * ADDED BY CINDY 4/14/2015***
   * sets an offset to the position at which the table header freezes. Useful for content above the table
   *
   * @type {Number}
   * @default 0
   */
...
//  instance.rootElement.addClass('handsontable');
  ...
  var walkontableConfig = {
    ...
    //** ADDED BY CINDY 4/14/2014 **//
    fixedRowsOffset: function () {
      return that.settings.fixedRowsOffset;
    },
...
WalkontableVerticalScrollbarNative.prototype.resetFixedPosition = function () {
  ...
  if (this.scrollHandler === window) {
    var box = this.instance.wtTable.holder.getBoundingClientRect();
    var fixedRowsOffset = this.instance.getSetting('fixedRowsOffset') ;
    var top = Math.ceil(box.top) - fixedRowsOffset;
    var bottom = Math.ceil(box.bottom);
